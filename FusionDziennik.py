                        ...
                        while decisionBeenMade == False:
                            if keyboard.read_key() == 'enter':
                                ...
                                if amounttt % 5 == 3:
                                    ...
                                    LessonsScheduleEditor()
                                if amounttt % 5 == 4:
                                    print('Wybierz dzień, na który ma zostać przeniesiony przedmiot {} ({}, nr godziny {}) z klasą {}:'.format(GetComponentOfLessonToEdit['przedmiot'], downloadTeacherData(GetComponentOfLessonToEdit['idNauczyciela']), str(GetComponentOfLessonToEdit['nrGodziny']), GetComponentOfLessonToEdit['klasa']))
